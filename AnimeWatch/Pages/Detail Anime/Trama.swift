...
struct Trama: View {
    ...
    init(data: Attributes, animeGenres: [GenreAnimeDetail], animeCharacters: [CharactersDetail], animeReactions: [ReactionsAnimeDetail], averageRating: Double){
        self.data = data
        self.averageRating = averageRating
        self.animeGenres = animeGenres
        self.animeCharacters = animeCharacters
        self.animeReactions = animeReactions
    }
